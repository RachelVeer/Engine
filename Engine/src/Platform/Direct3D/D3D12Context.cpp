...
void LoadAssets()
{
    ...
    // Create the pipeline state, which includes compiling and loading shaders.
    {
        ...
        ThrowIfFailed(D3DCompileFromFile(GetAssetFullPath(L"src/shaders.hlsl").c_str(), nullptr, nullptr, "VSMain", "vs_5_0", compileFlags, 0, &vertexShader, nullptr));
        ThrowIfFailed(D3DCompileFromFile(GetAssetFullPath(L"src/shaders.hlsl").c_str(), nullptr, nullptr, "PSMain", "ps_5_0", compileFlags, 0, &pixelShader, nullptr));
